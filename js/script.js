...
const data = [
  ...
  const backBtn = document.querySelector("#botao-voltar");
    ...
    function cleanInputs (){ //funcao para limpar o que a pessoa digitou
      heightInput.value="";
      weightInput.value="";
      imcNumber.classList = "";
      imcInfo.classList = "";
    ...
    function validDigits(text){ //funcao para limitar o numero de caracteres 
